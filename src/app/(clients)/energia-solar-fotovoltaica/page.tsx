              ...
              <div className="lg:col-span-2">
                <div className="py-8">
                  <div className="space-y-5 lg:space-y-8">
                    ...
                    <iframe width="400" height="315" src="https://www.youtube.com/embed/EU1Lk7Xn3-U?si=m1FJGeRML1pi5EM0" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                    </figure>
                    <h3 className="text-2xl font-bold dark:text-yellow-400 lg:text-3xl">
