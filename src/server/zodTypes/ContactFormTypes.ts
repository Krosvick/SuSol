...
export const ContactFormSchema = z.object({
    nombre: z.string().regex(/^[a-zA-Z]+$/, { message: 'El nombre debe contener solo letras' }).min(2, { message: 'El nombre debe tener al menos 2 caracteres' }),
    apellido: z.string().regex(/^[a-zA-Z]+$/, { message: 'El apellido debe contener solo letras' }).min(2, { message: 'El apellido debe tener al menos 2 caracteres' }),
