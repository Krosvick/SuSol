...
export function MainSection(){
    return (
        ...
        <header className="z-30 relative h-screen flex flex-col justify-center items-center px-5 lg:px-60 text-wrap">
          ...
          <p className="h-1/3 lg:pt-24 my-20 lg:my-0 text-sm lg:text-base 2xl:text-3xl text-center">Brindamos soluciones de energías renovables para Tarapacá y el país, con el fin de lograr un Chile más sustentable al alcance de todos los chilenos</p>
          <svg xmlns="http://www.w3.org/2000/svg" height="32" width="30" viewBox="0 0 448 512" className='lg:mb-5 mb-10'><path fill="#ffffff" d="M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z"/></svg>
        </header>
