...
export function MainSection(){
    return (
        ...
        <header className="z-30 relative h-screen flex flex-col justify-center items-center px-5 lg:px-60 text-wrap">
          ...
          <p className="h-1/3 lg:pt-24 my-20 lg:my-0 text-sm lg:text-base text-center">Brindamos soluciones de energías renovables para Tarapacá y el país, con el fin de lograr un Chile más sustentable al alcance de todos los chilenos</p>
